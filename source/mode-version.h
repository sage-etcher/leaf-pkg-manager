 ...
 *
 * /source/mode-version.h
 * Contains prototypes and includes for code defined in '/source/mode-version.c'.
 *
 */
...
/* run once */
#pragma once
#ifndef __PKG_MODE_VERSION_HEADER__
#define __PKG_MODE_VERSION_HEADER__
